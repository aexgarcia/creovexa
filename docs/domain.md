...
Los incrementos 1–3 tienen entidades, casos de uso, contratos y pruebas unitarias; el incremento 4 completa las reglas de publicaciones y resumen de campaña con sus pruebas. La fase 3 añade [persistencia comercial](phase-3-commercial.md), [campañas con snapshots e historial](phase-3-campaigns.md) y [publicaciones e intentos](phase-3-publications.md). La fase 4 incorpora los [endpoints de productos y plantillas](phase-4-catalog.md). Después de revisar estos incrementos corresponde la API de campañas. Los casos de uso de envío real, las cuentas sociales y la autorización conservan las fases indicadas arriba.

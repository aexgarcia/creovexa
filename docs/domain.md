...
Estado: los cuatro incrementos de la fase 2 están implementados e integrados: base comercial, plantillas, campañas y resultados por destino. Actualizado el 21 de septiembre de 2026. Detalle de cambios y verificaciones en [base comercial](phase-2.md), [plantillas](phase-2-templates.md), [campañas](phase-2-campaigns.md) y [publicaciones](phase-2-publications.md). La fase 3 está integrada: [persistencia comercial](phase-3-commercial.md), [campañas](phase-3-campaigns.md) y [publicaciones e intentos](phase-3-publications.md). La fase 4 tiene integradas la [API de productos y plantillas](phase-4-catalog.md), [campañas](phase-4-campaigns.md) y [aprobación y consultas de publicaciones](phase-4-approval-publications.md), hasta el PR #16. Los contratos de generación y envío están [propuestos para las fases siguientes](generation-publication-contracts.md).
...
La clave lógica es `(organizationId, campaignId, approvedContentId, socialAccountId)`. La fase 3 la respalda con una restricción única y escrituras condicionadas por versión/estado. El contrato `PublicationTransaction` guarda campaña y destinos en una transacción; restricciones diferidas comprueban al commit que el resumen coincida con las filas persistidas. Una comprobación en memoria no evita que dos workers lean simultáneamente `APPROVED`.
...
Los incrementos 1–3 tienen entidades, casos de uso, contratos y pruebas unitarias; el incremento 4 completa las reglas de publicaciones y resumen de campaña con sus pruebas. La fase 3 añade [persistencia comercial](phase-3-commercial.md), [campañas con snapshots e historial](phase-3-campaigns.md) y [publicaciones e intentos](phase-3-publications.md). La fase 4 incorpora los [endpoints de productos y plantillas](phase-4-catalog.md). El incremento 3 añade [creación, listado y detalle HTTP de campañas](phase-4-campaigns.md). El incremento 4 incorpora [aprobación y consultas de publicaciones](phase-4-approval-publications.md). Quedan pendientes los contratos e integraciones de generación, regeneración y envío. Los casos de uso de envío real, las cuentas sociales y la autorización conservan las fases indicadas arriba.

...
Estado: los cuatro incrementos de la fase 2 están implementados e integrados: base comercial, plantillas, campañas y resultados por destino. Actualizado el 21 de septiembre de 2026. Detalle de cambios y verificaciones en [base comercial](phase-2.md), [plantillas](phase-2-templates.md), [campañas](phase-2-campaigns.md) y [publicaciones](phase-2-publications.md). La fase 3 está integrada: [persistencia comercial](phase-3-commercial.md), [campañas](phase-3-campaigns.md) y [publicaciones e intentos](phase-3-publications.md). La fase 4 incorpora la [API de productos y plantillas](phase-4-catalog.md), pendiente de revisión mediante PR.

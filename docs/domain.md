...
Los incrementos 1–3 tienen entidades, casos de uso, contratos y pruebas unitarias; el incremento 4 completa las reglas de publicaciones y resumen de campaña con sus pruebas. La fase 3 añade [Prisma y persistencia comercial](phase-3-commercial.md) sin endpoints de negocio. Después de revisar ese incremento corresponde persistir campañas, snapshots y contenido con control de versión. Los casos de uso de envío real, las cuentas sociales y la autorización conservan las fases indicadas arriba.
